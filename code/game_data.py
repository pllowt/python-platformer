level_0 = {
    ...
    'enemies': '../levels/0/level-0._enemies.csv',
    'constraints': '../levels/0/level-0._constraints.csv',
    'player': '../levels/0/level-0._player.csv',
    'grass': '../levels/0/level-0._grass.csv'
}